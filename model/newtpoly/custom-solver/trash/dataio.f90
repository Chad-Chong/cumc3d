...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,prim(imin:ibx-1,0:nx+1,0:ny+1,0:nz+1),dims4,error)
...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,epsilon(0:nx+1,0:ny+1,0:nz+1),dims3,error)
...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,temperature(0:nx+1,0:ny+1,0:nz+1),dims3,error)
...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,phi(0:nx+1,0:ny+1,0:nz+1),dims3,error)
...
! write dataset !
call h5dwrite_f(dset_id1,H5T_NATIVE_DOUBLE,prim(ibx:ibz,-1:nx+1,-1:ny+1,-1:nz+1),dims4,error)
