...
REAL*8, ALLOCATABLE, DIMENSION (:) :: epsilon, rho, abar, zbar, Ye, Tguess, T

CALL read_helm_table()

OPEN(UNIT=970, FILE = './Inter_SNEC.dat',status="old", action="read")
READ(970,*) n

ALLOCATE(epsilon(1:n))
ALLOCATE(rho(1:n))
ALLOCATE(abar(1:n))
ALLOCATE(zbar(1:n))
ALLOCATE(Ye(1:n))
...
DO i = 1, n
    dummy = 0
    CALL private_invert_helm_ed(epsilon(i), rho(i), abar(i), zbar(i), Ye(i), Tguess(i), T(i), &
                                dummy)
    IF (dummy == 1) THEN
        WRITE(*,*) 'Fail to converge for Tguess =', Tguess(i) 
    ENDIF
ENDDO
...
subroutine private_invert_helm_ed(epsilon_input, rho_input, abar_input, zbar_input, ye_input, temp_input, temp_output, &
                                flag_notfindtemp)
USE IEEE_ARITHMETIC
include '/home/cnchong/Codes/cumc3d/model/Type_Ia/src/implno.dek'
include '/home/cnchong/Codes/cumc3d/model/Type_Ia/src/const.dek'
include '/home/cnchong/Codes/cumc3d/model/Type_Ia/src/vector_eos.dek'
...
! initialize
    ...
    jlo_eos = 1
    jhi_eos = 1
    etot_row(1) 	= epsilon_input 
    temp_row(1) 	= temp_input
    den_row(1) 	= rho_input
...
! store the new temperature, keep it within the table limits
    temp_row(j)  = min(1.0d13,max(tmpnew,1.0d-3))
...
subroutine helmeos
include '/home/cnchong/Codes/cumc3d/model/Type_Ia/src/implno.dek'
include '/home/cnchong/Codes/cumc3d/model/Type_Ia/src/helm_const.dek'
include '/home/cnchong/Codes/cumc3d/model/Type_Ia/src/vector_eos.dek'
include '/home/cnchong/Codes/cumc3d/model/Type_Ia/src/helm_table_storage.dek'
