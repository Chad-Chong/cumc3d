...
! For HelmEOS!
REAL :: tR, tL, abarR, zbarR, abarL, zbarL
	...
	DO k = 1, ny
		DO j = 0, nx + 1 
			...
			IF (helmeos_flag == 1) THEN
				...
				! CALL PRIVATE_HELMEOS_AZBAR(primR(ihe4:ini56,j-1,k,l), abarR, zbarR, primR(iye2,j-1,k,l))
				! CALL PRIVATE_HELMEOS_AZBAR(primL(ihe4:ini56,j,k,l), abarL, zbarL, primL(iye2,j,k,l))

				! CALL invert_helm_pd(primR(irho,j-1,k,l), primR(itau,j-1,k,l), abarR, zbarR, primR(iye2,j-1,k,l), temp2(j-1,k,l), tR)
				! CALL invert_helm_pd(primL(irho,j,k,l), primL(itau,j,k,l), abarL, zbarL, primL(iye2,j,k,l), temp2(j-1,k,l), tL)

				! CALL HELM_EOSEPSILON(primR(irho,j-1,k,l), tR, abarR, zbarR, primR(iye2,j-1,k,l), epsR(j-1,k,l))
				! CALL HELM_EOSEPSILON(primL(irho,j,k,l), tL, abarL, zbarL, primL(iye2,j,k,l), epsL(j,k,l))
	...
	DO k = 0, ny + 1 
		DO j = 1, nx
			...
			IF (helmeos_flag == 1) THEN
				...
				! CALL PRIVATE_HELMEOS_AZBAR(primR(ihe4:ini56,j,k-1,l), abarR, zbarR, primR(iye2,j,k-1,l))
				! CALL PRIVATE_HELMEOS_AZBAR(primL(ihe4:ini56,j,k,l), abarL, zbarL, primL(iye2,j,k,l))

				! CALL invert_helm_pd(primR(irho,j,k-1,l), primR(itau,j,k-1,l), abarR, zbarR, primR(iye2,j,k-1,l), temp2(j,k-1,l), tR)
				! CALL invert_helm_pd(primL(irho,j,k,l), primL(itau,j,k,l), abarL, zbarL, primL(iye2,j,k,l), temp2(j,k-1,l), tL)

				! CALL HELM_EOSEPSILON(primR(irho,j,k-1,l), tR, abarR, zbarR, primR(iye2,j,k-1,l), epsR(j,k-1,l))
				! CALL HELM_EOSEPSILON(primL(irho,j,k,l), tL, abarL, zbarL, primL(iye2,j,k,l), epsL(j,k,l))
	...
	DO k = 1, ny
		DO j = 1, nx
			...
			IF (helmeos_flag == 1) THEN
				...
				! CALL PRIVATE_HELMEOS_AZBAR(primR(ihe4:ini56,j,k,l-1), abarR, zbarR, primR(iye2,j,k,l-1))
				! CALL PRIVATE_HELMEOS_AZBAR(primL(ihe4:ini56,j,k,l), abarL, zbarL, primL(iye2,j,k,l))

				! CALL invert_helm_pd(primR(irho,j,k,l-1), primR(itau,j,k,l-1), abarR, zbarR, primR(iye2,j,k,l-1), temp2(j,k,l-1), tR)
				! CALL invert_helm_pd(primL(irho,j,k,l), primL(itau,j,k,l), abarL, zbarL, primL(iye2,j,k,l), temp2(j,k,l-1), tL)

				! CALL HELM_EOSEPSILON(primR(irho,j,k,l-1), tR, abarR, zbarR, primR(iye2,j,k,l-1), epsR(j,k,l-1))
				! CALL HELM_EOSEPSILON(primL(irho,j,k,l), tL, abarL, zbarL, primL(iye2,j,k,l), epsL(j,k,l))
