	...
	DO k = 1, ny
		DO j = 0, nx + 1 
			...
			IF (helmeos_flag == 1) THEN
				CALL PPMC(wx(j,1:14), epsilon(j-2,k,l), epsilon(j-1,k,l), epsilon(j,k,l), epsilon(j+1,k,l), epsilon(j+2,k,l), epsR(j-1,k,l), epsL(j,k,l))
				CALL PPMC(wx(j,1:14), cs(j-2,k,l), cs(j-1,k,l), cs(j,k,l), cs(j+1,k,l), cs(j+2,k,l), csR(j-1,k,l), csL(j,k,l))
			ELSE
...
DO l = 1, nz
	DO k = 0, ny + 1 
		DO j = 1, nx
			...
			IF (helmeos_flag == 1) THEN
				CALL PPMC (wy(k,1:14), epsilon(j,k-2,l), epsilon(j,k-1,l), epsilon(j,k,l), epsilon(j,k+1,l), epsilon(j,k+2,l), epsR(j,k-1,l), epsL(j,k,l))
				CALL PPMC (wy(k,1:14), cs(j,k-2,l), cs(j,k-1,l), cs(j,k,l), cs(j,k+1,l), cs(j,k+2,l), csR(j,k-1,l), csL(j,k,l))
			ELSE
...
DO l = 0, nz + 1 
	DO k = 1, ny
		DO j = 1, nx
			...
			! Internal energy !
			IF (helmeos_flag == 1) THEN
				CALL PPMC (wz(l,1:14), epsilon(j,k,l-2), epsilon(j,k,l-1), epsilon(j,k,l), epsilon(j,k,l+1), epsilon(j,k,l+2), epsR(j,k,l-1), epsL(j,k,l))
				CALL PPMC (wz(l,1:14), cs(j,k,l-2), cs(j,k,l-1), cs(j,k,l), cs(j,k,l+1), cs(j,k,l+2), csR(j,k,l-1), csL(j,k,l))
			ELSE
