...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Do the y-sweep !
IF(n_dim > 1 ) THEN !axissym_flag /= 1
		...
		DO k = 0, ny
			DO j = 0, nx
				...
				! IF (min_Bx == 0.0D0) THEN
					...
					! ENDIF
				! ELSE
				! 	IF ( ABS(l_rk(ibx,j,k,l))/min_Bx < 1.0D-2 ) THEN
				! 	l_rk(ibx,j,k,l) = 0
				! 	ENDIF
				! ENDIF
				...
				! IF (min_By == 0.0D0) THEN ! Suppress numerical error
					...
					! ENDIF
				! ELSE
				! 	IF ( ABS(l_rk(iby,j,k,l))/min_By < 1.0D-2 ) THEN
				! 	l_rk(iby,j,k,l) = 0
				! 	ENDIF
				! ENDIF
				...
				! IF (min_Bz == 0.0D0) THEN
					...
					! ENDIF
				! ELSE
				! 	IF ( ABS(l_rk(ibz,j,k,l))/min_Bz < 1.0D-2 ) THEN
				! 	l_rk(ibz,j,k,l) = 0
				! 	ENDIF
				! ENDIF
