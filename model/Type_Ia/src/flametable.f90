...
! real*8, parameter :: rho2_burn_min = 1.62D-12
...
! REAL*8, parameter :: rho2_deton_min = 1.62D-12
...
open(unit=500, file=TRIM(table_dir)//'/def_table_7iso_2.0e9.dat',action='read')
...
open(unit=500, file=TRIM(table_dir)//'/det_table_7iso_2.5e9.dat',action='read')
...
! Input data    
real*8 :: temp_in, rho_in

! Intermediate data     
real*8 :: di, dj

! Output data
real*8 :: rho_out, temp_out, eps_out
...
! Output data
real*8 ::fusionrate_out
real*8, dimension(totalion) :: x_isotope_out
