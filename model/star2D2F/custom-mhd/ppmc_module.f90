...
DO l = iNM, iDM
	DO k = 1, ny
		DO j = 0, nx + 1 
			...
			! Internal energy !
			CALL EOSEPSILON (primR(irho,j-1,k,l), primR(itau,j-1,k,l), epsR(j-1,k,l),l)
			CALL EOSEPSILON (primL(irho,j,k,l), primL(itau,j,k,l), epsL(j,k,l),l)
			CALL EOSSNDSPEED (primR(itau,j-1,k,l), primR(irho,j-1,k,l), epsR(j-1,k,l), csR(j-1,k,l),l)
			CALL EOSSNDSPEED (primL(itau,j,k,l), primL(irho,j,k,l), epsL(j,k,l), csL(j,k,l),l)
...
DO l = iNM, iDM
	DO k = 0, ny + 1 
		DO j = 1, nx
			...
			! Internal energy !
			CALL EOSEPSILON (primR(irho,j,k-1,l), primR(itau,j,k-1,l), epsR(j,k-1,l),l)
			CALL EOSEPSILON (primL(irho,j,k,l), primL(itau,j,k,l), epsL(j,k,l),l)
			CALL EOSSNDSPEED (primR(itau,j,k-1,l), primR(irho,j,k-1,l), epsR(j,k-1,l), csR(j,k-1,l),l)
			CALL EOSSNDSPEED (primL(itau,j,k,l), primL(irho,j,k,l), epsL(j,k,l), csL(j,k,l),l)
